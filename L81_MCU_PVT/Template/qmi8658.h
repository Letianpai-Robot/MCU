...
//this gyro i2c addr, 0xd6 is 0x6b, 0xd4 is 0x6a
...
extern void qmi8658_read_acc_data(float acc[]);
extern void qmi8658_read_gyro_data(float acc[]);
extern uint8_t l81_AT_AG_R_func(char params[]);
extern uint8_t l81_AT_AG_R_raw_func(char params[]);
extern uint8_t l81_AT_cal_W_func(char params[]);
extern uint8_t l81_AT_AG_id_func(char params[]);

extern void qmi8658_read_gyro_data_x(float gyro_x);  //0826 rjq++
